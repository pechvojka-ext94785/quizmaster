...
Then('I should see the text "Your score is 3 correctly answered questions out of 10 which is 30%"', async function(this: World) {
    await expectTextToBe(this.page.locator('p'), 'Your score is 3 correctly answered questions out of 10 which is 30%')
})
